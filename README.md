...
_G.Auto_Unlock_FPS = true
spawn(function()
	while _G.Auto_Unlock_FPS do 
		setfpscap(999)
		wait(0.0000001)
	end
end)
...
_G.Werlis_Hub_Free_Script = true
spawn(function()
	while true do 
	   if _G.Werlis_Hub_Free_Script then
		print("Werlis Hub Script Free!!")
	end
end)
pcall(function()
    local g = game
    ...
    local l = g.Lighting
    local t = w.Terrain
    local fantasySky = l:FindFirstChild("FantasySky")
    if fantasySky then
        fantasySky:Destroy()
    end
    t.WaterWaveSize = 0
    ...
    for i, v in pairs(w.Camera:GetDescendants()) do
...
_G.Auto_Use_Code = true	
spawn(function()
    while task.wait() do
        if _G.Auto_Use_Code then
...
if game.CoreGui:FindFirstChild("WerlisHub") then
    game.CoreGui:FindFirstChild("WerlisHub"):Destroy()
end

local library = {
	WorkspaceName = "Werlis Hub Script Pc",
	flags = {},
	signals = {},
	objects = {},
	elements = {},
